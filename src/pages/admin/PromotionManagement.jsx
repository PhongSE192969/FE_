...
const PromotionManagement = () => {
  ...
  const t = (translations[language] || translations.vi).admin?.promotionManagement || {};
    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <StatCard
          ...
          value={stats.total}
          subtext={t.stats?.all || "All campaigns"}
          color="text-blue-600"
          bg="bg-blue-50"
        ...
        <StatCard
          ...
          value={stats.active}
          subtext={t.stats?.running || "Currently running"}
        ...
        <StatCard
          ...
          subtext={t.stats?.expired || "Expired or disabled"}
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="Expired">{t.table?.statusExpired || "Expired"}</option>
              ...
              {filteredPromotions.length > 0 ? (
                ...
                <tr>
                  ...
                  >
                    ...
                    {t.table?.noData || "No promotions found"}
